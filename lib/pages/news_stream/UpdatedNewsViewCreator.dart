...
class UpdatedNewsViewCreator extends StatelessWidget {
  ...
  Widget _buildPage({String nameOfNewsday, int position}) {
    return new NewsLandingPage(
      ...
      callToAction: listOfArticles[position].callToAction,
      contentURL: listOfArticles[position].contentURL,
      leftCallToAction: listOfArticles[position].leftCallToAction,
      leftURL: listOfArticles[position].leftURL,
      rightCallToAction: listOfArticles[position].rightCallToAction,
      rightURL: listOfArticles[position].rightURL,
      nPartC1: listOfArticles[position].nPartC1,
      nPartC2: listOfArticles[position].nPartC2,
      nPartC3: listOfArticles[position].nPartC3,
      nPartL1: listOfArticles[position].nPartL1,
      nPartL2: listOfArticles[position].nPartL2,
      nPartL3: listOfArticles[position].nPartL3,
      partisan: listOfArticles[position].partisan,
      userID: userID,
      firstName: firstName,
      lastName: lastName,
      userName: username,
